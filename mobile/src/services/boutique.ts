 ...
 * Types, donnees, helpers, fonctions mock
 *
...
// Etat de l'abonnement LPP+ retourne par le backend
...
// ============ BOOST TYPES (nouveau systeme objectif → intensite) ============
...
// ============ MOCK MARKETPLACE PRODUCTS (10 items) ============

// Helper pour generer des reviews mock
...
function normalizeLppResponse(response: ReponseAPI<any>): ReponseAPI<LppPlusSubscription> {
  ...
  // Le backend peut wrapper dans data.lppPlus ou renvoyer data directement
